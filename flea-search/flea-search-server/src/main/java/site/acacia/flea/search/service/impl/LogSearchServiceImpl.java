 ...
 */
@Service
public class LogSearchServiceImpl implements LogSearchService, Serializable {

	private static final long serialVersionUID = -5969110933456131029L;

	protected static Logger logger = LoggerFactory.getLogger(LogSearchService.class);
