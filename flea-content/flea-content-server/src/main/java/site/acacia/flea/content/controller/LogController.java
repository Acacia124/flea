package site.acacia.flea.content.controller;
...
import site.acacia.flea.content.socket.LoggerQueue;
...
public class LogController {
	...
	@RequestMapping(value = "/user/log/content/download", method = RequestMethod.GET)
					...
					try {
						...
						if (log != null) {
							if (messagingTemplate != null)
								messagingTemplate.convertAndSend("/topic/pullLoggerContent", log);
						}
					} catch (Exception e) {
						e.printStackTrace();
					}
